...
country = {
	...
	NEWSPAPER_PRINTING_FREQUENCY = 40000, -- days frequency when the news attempt to be printed (may not print if not enough facts collected, and retry after another X days)
	NEWSPAPER_TIMEOUT_PERIOD = 0, -- the max period for news that may be printed. The probability is decreased with time.
	NEWSPAPER_MAX_TENSION = 9999999, -- when tension of printing gets this high, the newspaper will attempt to be printed immediately.
